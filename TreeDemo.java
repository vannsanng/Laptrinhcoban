...
import com.mycompany.laptrinhjava.chuong05.logic.FileTreeModel;
import com.mycompany.laptrinhjava.chuong05.logic.TreeDemoModel;
import java.io.File;
...
public class TreeDemo extends javax.swing.JFrame {
    ...
    public TreeDemo() {
        ...
        tree = new FileTreeModel("D:\\du lieu c");
    ...
    private void initComponents() {
        ...
        setTitle("Minh hoạ sử dungk JTree");
    ...
    private void jTreeValueChanged(javax.swing.event.TreeSelectionEvent evt) {//GEN-FIRST:event_jTreeValueChanged
        ...
        if(node == null)
            return;
        File nodeInto = (File) node.getUserObject();
        FileAndDiretoryOperations fo = new FileAndDiretoryOperations();
        File[] list = fo.getDiretoryContent(nodeInto.getPath());
